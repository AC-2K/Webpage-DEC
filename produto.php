            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <?php echo '<img src="assets/DB/'.$rows['img'].'" alt="Projecto ">'; ?>
                    </div>
                </div>
                <div class="col-12 col-lg">
                    ...
                    <?php echo '<hr> '; ?>
                      ...
                      <?php echo '<p class="mbr-text mbr-fonts-style mt-3 display-7"> Area de cobertura - '.$rows['area'].'m2</p> '; ?>                            
                        ...
                        <?php echo '<div class="mbr-section-btn item-footer mt-2"><a  class="btn item-btn btn-success-outline display-7" target="_blank" rel="noopener noreferrer" href="https://api.whatsapp.com/send?phone= 258873100497&text=Cumprimentos! Estou interessado no projecto '.$rows['nome'].', visualizado a partir website" value="produto">Estou interessado</a></div>'; ?> 
                    </div>
                </div>
            </div>
        </div>
...
?>          
          <?php echo '<div class="col-12 col-md-6 col-lg-3 item gallery-image" >'; ?>
            ...
            <?php echo '<img class="w-100" src="assets/projectos/'.$rowt['ficheiro'].'" alt="Projecto DEC" data-slide-to="'.$count.'" data-bs-slide-to="'.$count.'" data-target="#lb-tPrCNM2GgJ" data-bs-target="#lb-tPrCNM2GgJ">'; ?>                   
                            ...
                            ?>
                              <?php if ($count == 0)  { ?>
                                <?php echo '<div class="carousel-item active">'; ?>
                                  <?php echo '<img class="d-block w-100" src="assets/projectos/'.$rowt['ficheiro'].'" alt="Projecto DEC">'; ?>
                                <?php echo '</div>'; ?>                               
                              <?php } else { ?>
